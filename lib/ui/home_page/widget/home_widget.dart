...
import 'package:drama_chaska/custom_widget/custom_blur_widget.dart';
import 'package:drama_chaska/main.dart';
import 'package:drama_chaska/routes/app_routes.dart';
import 'package:drama_chaska/shimmer/carousel_shimmer.dart';
import 'package:drama_chaska/shimmer/most_trending_shimmer.dart';
import 'package:drama_chaska/shimmer/new_release_shimmer.dart';
import 'package:drama_chaska/ui/home_page/controller/home_controller.dart';
import 'package:drama_chaska/ui/home_page/model/get_movies_grouped_by_category_model.dart';
import 'package:drama_chaska/ui/home_page/model/new_releases_video_model.dart';
import 'package:drama_chaska/ui/home_page/model/trending_movie_series_model.dart';
import 'package:drama_chaska/ui/home_page/view/view_all_page.dart';
import 'package:drama_chaska/utils/app_button.dart';
...
import 'package:drama_chaska/utils/dummy_data.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(
      ...
      builder: (logic) {
        ...
        final data = logic.getMoviesSeriesModel?.data ?? [];
        final hasData = data.isNotEmpty;
        final currentIndex = logic.initialPage;
        
        // Check if the current index is valid
        final isValidIndex = hasData && currentIndex >= 0 && currentIndex < data.length;
        final imageUrl = isValidIndex ? data[currentIndex].thumbnail ?? "" : "";
...
class ContinueWatchingItemView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Print the whole incoming data
    print("ContinueWatchingItemView - data received: $data");
    ...
    print("Computed progressValue: $progressValue");

    return GestureDetector(
      onTap: () {
        print("Tapped ContinueWatchingItemView, navigating to episodeWiseReels with arguments:");
        print({
