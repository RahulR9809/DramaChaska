...
import 'package:drama_chaska/custom_widget/custom_icon_button.dart';
...
import 'package:drama_chaska/ui/reels_page/api/create_favorite_video_api.dart';
                      ...
                      children: [
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            else if (index < controller.mainReels.length && 
         (controller.mainReels[index].isLocked == false || Preference.isVip == true)) {
                              return GestureDetector(
                                onTap: () {
                                  controller.jumpPage(index);
                                },
